...
[![bundlejs](https://deno.bundlejs.com/?q=use-fun-hooks@0.0.1,use-fun-hooks@0.0.1&treeshake=[*],[{+default+}]&config={%22esbuild%22:{%22external%22:[%22react%22]}}&badge=)](https://bundlejs.com/?q=use-fun-hooks)
